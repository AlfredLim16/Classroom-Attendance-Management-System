...
import validations.ExcuseLetterValidator;
import java.time.LocalDate;
import java.time.LocalDateTime;
import java.util.Objects;

public record ExcuseLetter(
    int excuseId, Student student, Course course, LocalDate absentDate, String reason, String supportingDocumentPath, ExcuseStatus status, User reviewedBy, LocalDateTime submittedDate, LocalDateTime reviewedDate) {

    public ExcuseLetter {
        ExcuseLetterValidator.validate(student, course, absentDate, reason, status, submittedDate);
    }
    ...
    public boolean equals(Object object) {
        ...
        ExcuseLetter that = (ExcuseLetter) object;
        return excuseId == that.excuseId;
    }

    @Override
    public int hashCode() {
        return Objects.hash(excuseId);
    }

    @Override
    public String toString() {
        return "ExcuseLetter{id=" + excuseId + ", student=" + (student != null ? student.studentNumber() : "null") + ", course=" + (course != null ? course.courseCode() : "null") + ", status=" + status + "}";
    }
