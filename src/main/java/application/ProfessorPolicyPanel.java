...
import session.AttendancePolicy;
import session.AttendancePolicyService;
...
public class ProfessorPolicyPanel extends JPanel implements ActionListener {
    ...
    private void togglePolicy(){
        ...
        policyService.updateAttendancePolicy(updated);
        JOptionPane.showMessageDialog(this, "Policy toggled to " + (updated.active() ? "Active" : "Inactive") + ".", "Success", JOptionPane.INFORMATION_MESSAGE);
        loadPolicies();
    }
