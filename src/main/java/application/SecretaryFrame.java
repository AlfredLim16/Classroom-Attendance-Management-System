...
public class SecretaryFrame extends JFrame implements ActionListener {
    ...
    public void setCurrentUser(User user){
        ...
        String studentNumber = username.startsWith("sec.") ? username.substring(4) : username;

        secretaryService.getSecretaryByStudentNumber(studentNumber).ifPresentOrElse(
            sec -> {
                this.secretary = sec;
            ...
            () -> {
                JOptionPane.showMessageDialog(this,
                    "No secretary record found for: " + username + "\n(looking for studentNumber: " + studentNumber + ")",
