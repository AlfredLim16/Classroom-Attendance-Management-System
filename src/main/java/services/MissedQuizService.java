...
/**
 * Handles creation and resolution of missed quiz flags.
 */
public class MissedQuizService {
    ...
    /**
     * Creates a new PENDING missed quiz entry for a student.
     * decisionType and decidedByProfessor are null until the professor resolves it.
     */
    ...
    /**
     * Professor resolves a missed quiz flag with a decision.
     */
    public void resolveFlag(int flagId, DecisionType decision,
        ...
        MissedQuizStatus newStatus = switch (decision) {
            case MAKEUP          -> MissedQuizStatus.APPROVED;
            case ZERO            -> MissedQuizStatus.REJECTED;
            case EXCUSED_ABSENCE -> MissedQuizStatus.EXCUSED;
        };
