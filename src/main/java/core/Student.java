...
import validations.StudentValidator;
...
public record Student(int studentId, User user, String studentNumber, String firstName, String middleName, String lastName, Program program, YearLevel yearLevel, Section section) {
    ...
    public Student {
        StudentValidator.validate(user, studentNumber, firstName, middleName, lastName, program, yearLevel, section);
    }
    ...
    public String toString() {
        return "Student{id=" + studentId + ", number='" + studentNumber + "', name='" + getFullName() + "'}";
    }
